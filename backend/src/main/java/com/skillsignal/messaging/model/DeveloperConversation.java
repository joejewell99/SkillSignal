...
@Entity
@Table(name = "developer_conversations", indexes = {
        @Index(name = "idx_conversation_requester", columnList = "requester_user_id"),
        @Index(name = "idx_conversation_receiver", columnList = "receiver_user_id"),
